...
<div x-data="{ actionsOpen: false }" class="relative inline-block text-right" x-cloak>
    ...
    <button @click.stop="actionsOpen = !actionsOpen"
        class="inline-flex cursor-pointer items-center p-2 text-gray-400 bg-white rounded-full hover:text-gray-600 focus:outline-hidden focus:ring-2 focus:ring-offset-2 {{ 'focus:ring-' . $baseColor . '-500' }} dark:bg-gray-800 dark:text-gray-500 dark:hover:text-gray-300">
    ...
    {{-- Actions Dropdown --}}
    <div x-show="actionsOpen" @click.away="actionsOpen = false" x-transition:enter="transition ease-out duration-100"
