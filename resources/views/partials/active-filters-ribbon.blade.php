    ...
    @if(!empty($activeFilters))
        <div class="mt-2 border-t border-gray-200 dark:border-gray-700 py-3">
            <div class="flex flex-wrap items-center gap-2">
                <span class="text-xs text-gray-600 dark:text-gray-300 ml-2">Active filters:</span>
                @foreach($activeFilters as $af)
                    <span
                        class="inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-200">
