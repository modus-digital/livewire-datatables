        ...
        <div class="mt-4 flex justify-center space-x-3">
            @if($this->search)
                <button wire:click="clearSearch"
                    class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 {{ 'focus:ring-' . $baseColor . '-500' }} dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600">
                    Clear search
                </button>
            @endif
